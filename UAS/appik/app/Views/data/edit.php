...
<div class="home-content">
    ...
    <div class="overview-boxes">
        <a data-bs-toggle="popover" data-bs-placement="right" data-bs-custom-class="custom-popover" data-bs-html="true" title="Komentar" data-bs-content="<?= $data['pesan']; ?>"><i style="font-size: 35px;" class='bx bxs-message-edit'></i></a>
        <!-- fieldsets -->
        <div class="card" style="width:100%;z-index: 1;">
            ...
            <form id="msform" action="/data/update/<?= $data['id']; ?>" method="POST" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                ...
                <?php else : ?>
                    <fieldset>
                        ...
                        <textarea class="form-control <?= ($validation->hasError('judul')) ? 'is-invalid' : ''; ?>" placeholder="Input Judul Dokumen IK disini. . ." name="judul" id="judul"><?= (old('judul')) ? old('judul') : (($data['judul']) ? $data['judul'] : '<h1></h1>'); ?></textarea>
                        <div class="invalid-feedback">
                ...
                <div class="card-footer text-center">
                    <small><a href="<?= base_url('data'); ?>">&laquo; back to data list</a></small>
                </div>
            </form>
        </div>
