      <div class="navbar navbar-fixed-top navbar-inverse">
            <div class="navbar-inner">
                <div class="container">
					...
					<ul class="nav">
					<li class="active"><a href="dashboard.php"><i class="icon-home icon-large"></i>&nbsp;Beranda</a></li>
					<li><a href="users.php"><i class="icon-user icon-large"></i>&nbsp;User</a></li>
					<?php 
					...
					<li><a href="#myModal" data-toggle="modal"><i class="icon-search icon-large"></i>&nbsp;Cari</a></li>
