...
<script type="text/javascript" src="function_delete.js"></script>
						<!-- end: TOOLBAR -->
						<!-- end: PAGE HEADER -->
						<!-- start: BREADCRUMB -->
						<div class="row">
...
$sql_news="SELECT
id_buku,judul,isi,status,pengarang,picture,pengirim,penerbit,date,lihat from tb_buku
...
?>
												...
												<ul class="dropdown-menu" role="menu">
													<li>
														<a href="ver_ubah.php?verubah=<?php echo"$hsl_news[id_buku]";?>">
															<i class="fa fa-pencil"></i> Edit
														</a>
													</li>
													<li>
														<a href="ver_delete.php?idhapus=<?php echo"$hsl_news[id_buku]";?>" onClick="return warning();"> 
											...
											<td>
											<a href="ver_detailbuku.php?iddetail=<?php echo $hsl_news['id_buku'];?>"><button type="button" class="btn btn-light-azure">
										Lihat Buku
											</button></a>
										<a href="ver_spoilerbuku.php"><button type="button" class="btn btn-dark-green">
											Spoiler
											</button></td>
															</tr>
													<?php } ?>
