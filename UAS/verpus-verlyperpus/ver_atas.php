...
<!-- Mirrored from www.cliptheme.com/demo/rapido/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Nov 2014 00:36:39 GMT -->
<head>
		<title>Verpus-VerlyPerpustakaan</title>
		<!-- start: META -->
		<meta charset="utf-8" />
						...
						<ul class="nav navbar-right">
							...
							<li class="dropdown current-user">
								<a data-toggle="dropdown" data-hover="dropdown" class="dropdown-toggle" data-close-others="true" href="#">
									<img src="assets/avatar/<?php echo   $_SESSION['img'];?> " width="30px" height="30px"class="img-circle" alt=""> <span class="username hidden-xs"><?php echo $_SESSION['username'];?></span> <i class="fa fa-caret-down "></i>
								</a>
				<!--STOP:  VERLY MINI AVATAR-->
								<ul class="dropdown-menu dropdown-dark">
									...
									<li>
										<a href="ver_lockscreen.php">
											Lock Screen
										</a>
									</li>
									<li>
										<a href="ver_logout.php">
											Log Out
										</a>
									</li>
								</ul>
			...
			<nav id="pageslide-left" class="pageslide inner">
				<div class="navbar-content">
					...
					<div class="main-navigation left-wrapper transition-left">
						...
						<!--START:  VERLY SESSION USERNAME AND AVATAR-->
    ...
    die("Anda bukan admin");//jika bukan admin jangan lanjut
						...
						<div class="user-profile border-top padding-horizontal-10 block">
							<div class="inline-block">
							                     <img src="assets/avatar/<?php echo   $_SESSION['img'];?>"widht="150px" height="150px"></img> 
													</div>

							<div class="inline-block">
								<h5 class="no-margin"> Welcome </h5>
								<h4 class="no-margin"> <?php echo $_SESSION['username'];?>
								
							</div>
						</div>
						<!-- STOP: VERLY SESSION USERNAME AND AVATAR-->
				...
				<div class="slide-tools">
					...
					<div class="col-xs-6 text-right no-padding">
						<a class="btn btn-sm log-out text-right" href="ver_logout.php">
					...
					<div class="hidden-xs" id="style_selector">
						<div id="style_selector_container">
							...
							<div class="images icons-color">
								...
								<a href="#" id="style2"><img src="assets/images/color-2.png" alt="" class="active"></a>
						...
						<div class="toolbar row">
							<div class="col-sm-12 hidden-xs">
								<div class="page-header">
									<h1>Verpus-Verly Perpustakaan </h1>
									<center><b>Pinjam & Baca </b></center>
								</div>
							</div>
							</div>