							...
							<div class="col-md-12">
								...
								<div class="panel panel-white">
									<div class="panel-heading">
										<h4 class="panel-title">Form <span class="text-bold">Buku</span> yang di Pinjam</h4>
...
$sql_news="SELECT * FROM tb_peminjam
WHERE id_login='$id_user' ORDER by date"; 
$qry_newss=mysql_query($sql_news,$konek)
or die ("gagal menampilkan".mysql_error());
while($verliqueri=mysql_fetch_array($qry_newss)) {
$verlijudul=$verliqueri['judul'];
$verlipict=$verliqueri['picture'];
$verlipengarang=$verliqueri['pengarang'];
$verlipenerbit=$verliqueri['penerbit'];
$verlidesc=$verliqueri['isi'];
$verlipengirim=$verliqueri['pengirim'];
$idpenerbit=$verliqueri['id_penerbit'];
$tgl=substr($verliqueri['date'],8,2);  
$bln=substr($verliqueri['date'],5,2);  
$thn=substr($verliqueri['date'],0,4); 
?>
													<tr>
														<?php
														error_reporting(0);
													    ...
													    <td><img src="assets/verlybook/<?php echo $verliqueri['picture'];?> "width="120" height="120"></td>
														<td><b><?php echo  $verlijudul;?></b></td>
														...
														<td><?php echo $bln;?>-<?php echo $tgl;?>-<?php echo $thn;?></td>
															<td>
													<?php if($verliqueri['status']=='P'){ ?>
													<a href="ver_kembalikanUSER.php?idkembalikan=<?php echo $verliqueri['id_buku'];?>"><button type="button" class="btn btn-blue">
															Sudah Di Pinjam | Klik Untuk (Kembalikan Buku)
													</button>
													<?php }else if($verliqueri['status']=='K'){ ?>
