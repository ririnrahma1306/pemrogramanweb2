									...
									<div class="panel-body">
											...
											<div class="timeline">
												...
												<div class="date_separator" id="november" data-appear-top-offset="-400">
													<span>LIHAT DULU SEBELUM PINJAM</span>
												</div>
												<ul class="columns">
	<?php
		include_once "config/koneksi.php";
$sql_news="SELECT
id_buku,judul,isi,status,pengarang,picture,pengirim,date,lihat from tb_buku
INNER JOIN tb_penerbit on tb_penerbit.id_penerbit=tb_buku.id_penerbit
INNER JOIN tb_pengarang on tb_pengarang.id_pengarang=tb_buku.id_pengarang WHERE status='T'
ORDER by date";
													...
													<li>
														<div class="timeline_element partition-white">
															<div class="timeline_date">
																<div>
																	<div class="inline-block">
																		<span class="day text-bold"><?php echo $tgl;?></span>
																	</div>
																	<div class="inline-block">
																		<span class="block week-day text-extra-large"><b><font color="red">-<?php echo $bln;?></b></font></span>
																		<span class="block month text-large text-light"><?php echo $thn;?></span>
																	</div>
																	<br>
																	<img src="assets/verlybook/<?php echo $verlipict;?> "width="200" height="200">
																</div>
															</div>
															<div class="timeline_title">
																<i class="fa fa-check fa-2x pull-left fa-border"></i>
																<h4 class="light-text no-margin padding-5"><?php echo $verlijudul;?></h4>
															</div>
															...
															<?php if($hsl_news['status']=='T'){ ?>
																<a href="<?php echo $url_link?>"class="btn btn-green">
																	Lihat Dulu <i class="fa fa-arrow-circle-right"></i>
																</a>
																<?php }else if($hsl_news['status']=='F'){ ?>
																<a href="#"class="btn btn-green">
																	Stock Kosong Not Avaible <i class="fa fa-arrow-circle-right"></i>
																</a>
																<?php } ?>
															</div>
														</div>
